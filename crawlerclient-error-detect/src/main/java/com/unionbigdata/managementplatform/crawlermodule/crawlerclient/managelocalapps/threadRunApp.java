...
public class threadRunApp implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            UploadRestService uploadRestService = new UploadRestService();
            Job job = new Job(0,appInfo.getId(),pid,isRun,parameter,linuxProcessInfo.getCpu_percent(),
                    (long)linuxProcessInfo.getMem_percent()*appManage.getTotalMEMSize(),uploadRestService.getCurrentTime(),
